...
async def ingress_file_doc(file_name:str, file_path:str, section = ""):
    ...
    try:
        ...
        if existing_file:
            ...
            # print(f"content:{page.decode('utf8')}")
            file_content = page.decode('utf8')
            insert_file_metadata(file_name, table_name, file_content)
            return await process_all_files_in_section(file_name, table_name, file_content)
